...
x = df.drop(['pod_perehod', 'rasdelitel', 'ostrov_bezop', 'otboinik', 'ogr_skorosti', 'dor_znaki', 'napr_dvizhenia'],
            axis=1)
x = x.drop(['kol_bus', 'kol_vel', 'nal_vel', 'nal_trot', 'kol_cezd', 'nal_tram', 'nal_trol', 'nal_most', 'nal_tunnel'],
           axis=1)
